		...
		<?php
			...
			if ( isset( $_GET['section'] ) && $_GET['section'] == 'register' ) {
				...
				$settings = array(
					...
					'prdctfltr_termcount' => array(
						'name' => __( 'Term Product Counts Mode', 'prdctfltr' ),
						'type' => 'select',
						'desc' => __( 'Select how to get the term products count.', 'prdctfltr' ),
						'id'   => 'wc_settings_prdctfltr_termcount',
						'options' => array(
							'deep' => __( 'Deep, Slow and Precise', 'prdctfltr' ),
							'simple' => __( 'Simple and Fast', 'prdctfltr' )
						),
						'default' => 'deep',
						'css' => 'width:300px;margin-right:12px;'
					),
